...
`,c=null,D=null;function P(t){return c||(D=t,c=document.createElement("button"),c.className="blindspot-trigger",c.innerHTML=`
  ...
  `,a.placeholder="Type text...";let l=f=>{f.stopPropagation(),f.key==="Enter"?(f.preventDefault(),a.value.trim()&&J(o,n,a.value.trim()),w()):f.key==="Escape"&&(f.preventDefault(),w())},E=()=>{setTimeout(()=>{a&&a.value.trim()&&J(o,n,a.value.trim()),w()},100)};a.addEventListener("keydown",l),a.addEventListener("blur",E),r.appendChild(a),document.body.appendChild(r),setTimeout(()=>{a&&a.focus()},10),console.log("[Blindspot] Text input shown at",t,e)}function w(){let t=document.getElementById("blindspot-text-container");t&&t.remove(),a=null}function J(t,e,o){p.push({type:"text",x:t,y:e,text:o}),y(),console.log("[Blindspot] Text added:",o)}function ot(t){t.preventDefault();let e=t.touches[0],o=new MouseEvent("mousedown",{clientX:e.clientX,clientY:e.clientY});j(o)}function nt(t){t.preventDefault();let e=t.touches[0],o=new MouseEvent("mousemove",{clientX:e.clientX,clientY:e.clientY});z(o)}function it(t){let e=new MouseEvent("mouseup",{});x(e)}function It(t,e){u==="arrow"?st(b,h,t,e):u==="rectangle"&&rt(b,h,t,e)}function y(){s.clearRect(0,0,i.width,i.height),s.strokeStyle=T,s.lineWidth=G;for(let t of p)t.type==="draw"?Ot(t.points):t.type==="arrow"?st(t.startX,t.startY,t.endX,t.endY):t.type==="rectangle"?rt(t.startX,t.startY,t.endX,t.endY):t.type==="text"&&Ut(t.x,t.y,t.text)}function Ot(t){if(!(t.length<2)){s.beginPath(),s.moveTo(t[0].x,t[0].y);for(let e=1;e<t.length;e++)s.lineTo(t[e].x,t[e].y);s.stroke()}}function st(t,e,o,n){let l=Math.atan2(n-e,o-t);s.beginPath(),s.moveTo(t,e),s.lineTo(o,n),s.stroke(),s.beginPath(),s.moveTo(o,n),s.lineTo(o-15*Math.cos(l-Math.PI/6),n-15*Math.sin(l-Math.PI/6)),s.moveTo(o,n),s.lineTo(o-15*Math.cos(l+Math.PI/6),n-15*Math.sin(l+Math.PI/6)),s.stroke()}function rt(t,e,o,n){s.beginPath(),s.rect(t,e,o-t,n-e),s.stroke()}function Ut(t,e,o){s.font=`bold ${Rt}px -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif`,s.fillStyle=T,s.fillText(o,t,e)}function lt(){i&&(w(),i.removeEventListener("mousedown",j),i.removeEventListener("mousemove",z),i.removeEventListener("mouseup",x),i.removeEventListener("mouseleave",x),i.removeEventListener("touchstart",ot),i.removeEventListener("touchmove",nt),i.removeEventListener("touchend",it),i=null,s=null,p=[])}var at=null,k=null,m={arrow:`<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
